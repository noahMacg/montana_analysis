...
## Association rules analysis using arules package and scatterplot
...
## Create a scatterplot for each rule

```{r}
# Create scatterplot with support on x-axis, confidence on y-axis, colored by lift
plot(high_lift_rules,
     method = "scatterplot",
